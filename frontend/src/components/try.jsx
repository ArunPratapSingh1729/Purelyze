...
const Home = () => {
  return (
    <>
      {/* <!-- Start block --> */}
      <section className="bg-white  bg-gradient-to-r from-[#00244A] to-[#1A2D43]">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
              Scan. Analyze. Decide.
            </h1>
            <p className="max-w-2xl mb-6 text-gray-00 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-300 font-normal">
          ...
          <div className="hidden lg:flex lg:col-span-5 lg:mt-0 rounded shadow-lg text-white">
      ...
      {/* <!-- Start block --> */}
      <section className="bg-gray-50 bg-gradient-to-r from-[#2F4F4F] to-[#556B2F]">
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
          ...
          <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            <img
              className="w-full mb-4 rounded-lg lg:mb-0 lg:flex"
              src="./src/assets/images/Solutionimage.jpg"
              alt="feature image 2"
            />
            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
              <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
